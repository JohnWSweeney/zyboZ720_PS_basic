...
#
# create_project.tcl: Tcl script for re-creating project 'zyboZ720_PS_basic'
#
# Generated by Vivado on Sat Aug 30 15:16:23 -0700 2025
...
#
#    "C:/Users/JohnW/OneDrive/Documents/VHDL/zyboZ720_PS_basic/zyboZ720_PS_basic.srcs/utils_1/imports/synth_1/bdPsBasic_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../VHDL/zyboZ720_PS_basic/zyboZ720_PS_basic.srcs/utils_1/imports/synth_1/bdPsBasic_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "zyboZ720_PS_basic"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../VHDL/zyboZ720_PS_basic"]"
...
set_property -name "top" -value "bdPsBasic_wrapper" -objects $obj
...
set file "synth_1/bdPsBasic_wrapper.dcp"
...
# Proc to create BD bdPsBasic
proc cr_bd_bdPsBasic { parentCell } {
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-158,-46",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 2 -x 420 -y 50 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 2 -x 420 -y 80 -defaultsOSRD
...
preplace netloc processing_system7_0_DDR 1 1 1 400J 50n
preplace netloc processing_system7_0_FIXED_IO 1 1 1 NJ 80
levelinfo -pg 1 0 210 420
pagesize -pg 1 -db -bbox -sgen 0 0 530 230
"
}
...
# End of cr_bd_bdPsBasic()

cr_bd_bdPsBasic ""
set_property REGISTERED_WITH_MANAGER "1" [get_files bdPsBasic.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files bdPsBasic.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list bdPsBasic.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../VHDL/zyboZ720_PS_basic/zyboZ720_PS_basic.gen/sources_1/bd/bdPsBasic/hdl/bdPsBasic_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list bdPsBasic.bd]] -top]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/zyboZ720_PS_basic.srcs/utils_1/imports/synth_1/bdPsBasic_wrapper.dcp" -objects $obj
